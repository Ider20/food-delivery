...
export const HomePic = () => {
  return (
    <div>
      ...
      <div className="w-100 bg-[#18BA51] bg-watermark">
        <div className="w-[1440px] h-[788px] m-auto ">
          <div className="w-[1250px] h-[788px] m-auto flex items-center justify-between">
            ...
            <div className="">
              <img
                ...
                alt=""
                className="w-[443px] absolute hover:scale-105 duration-200"
              />
              <img
                src="/assets/hool02.png"
                alt=""
                className="w-[313px] relative ml-[280px] mt-[110px] hover:scale-105 duration-200"
              />
            </div>
          </div>
        </div>
